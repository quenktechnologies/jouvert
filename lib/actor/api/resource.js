...
exports.Resource = exports.BatchResponse = exports.TransportError = exports.Aborted = exports.BatchSend = exports.Send = exports.CLIENT_TAG_KEY = void 0;
...
var BatchSend = /** @class */ (function () {
    function BatchSend(client, requests) {
        this.client = client;
...
var BatchResponse = /** @class */ (function () {
    function BatchResponse(responses) {
    ...
    function Resource(agent, client, system) {
        ...
        _this.batchSend = function (_a) {
            ...
            var onSucc = function (res) {
                _this.tell(client, new BatchResponse(res));
            };
        ...
        _this.receive = [
            ...
            new case_1.Case(BatchSend, _this.batchSend),
