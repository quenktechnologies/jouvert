...
class RemoteModel {
    ...
    update(id, changes) {
        return (0, future_1.fromCallback)(cb => {
            this.spawn((s) => new callback_1.SendCallback(s, this.remote, new request_1.Patch((0, string_1.interpolate)(this.path, { id }), changes), new FutureHandler(this.handler, cb, r => {
    ...
    get(id) {
        return (0, future_1.fromCallback)(cb => {
            this.spawn((s) => new callback_1.SendCallback(s, this.remote, new request_1.Get((0, string_1.interpolate)(this.path, { id }), {}), new NotFoundHandler(this.handler, cb, () => {
    ...
    remove(id) {
        return (0, future_1.fromCallback)(cb => {
            this.spawn((s) => new callback_1.SendCallback(s, this.remote, new request_1.Delete((0, string_1.interpolate)(this.path, { id }), {}), new FutureHandler(this.handler, cb, r => {
                cb(null, (r.code === 200) ? true : false);
            })));
        });
    }
