...
var SaveFailedCase = /** @class */ (function (_super) {
    ...
    function SaveFailedCase(listener) {
        var _this = _super.call(this, SaveFailed, function (fail) { return future_1.doFuture(function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, future_1.wrap(listener.onSaveFailed(fail))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, future_1.wrap(listener.onSaveFinished())];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, future_1.voidPure];
                }
...
var SaveOkCase = /** @class */ (function (_super) {
    ...
    function SaveOkCase(form) {
        var _this = _super.call(this, SaveOk, function (ok) { return future_1.doFuture(function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, future_1.wrap(form.onSaveOk(ok))];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, future_1.wrap(form.onSaveFinished())];
                    case 2:
                        _a.sent();
...
var BaseFormScene = /** @class */ (function (_super) {
    ...
    BaseFormScene.prototype.onSaveFailed = function () { };
    BaseFormScene.prototype.onSaveOk = function () { };
    BaseFormScene.prototype.onSaveFinished = function () { };
