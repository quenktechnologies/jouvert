...
exports.whenSaving = exports.whenResumed = exports.AbstractRemoteFormService = exports.FormSaved = exports.Save = exports.Suspend = exports.Event = void 0;
...
Object.defineProperty(exports, "Event", { enumerable: true, get: function () { return form_2.Event; } });
Object.defineProperty(exports, "Save", { enumerable: true, get: function () { return form_2.Save; } });
Object.defineProperty(exports, "FormSaved", { enumerable: true, get: function () { return form_2.FormSaved; } });
...
var AbstractRemoteFormService = /** @class */ (function (_super) {
    ...
    AbstractRemoteFormService.prototype.resumedAdditions = function (r) {
        return __spreadArrays(this.remoteResumedAdditions(r), exports.whenResumed(this));
    };
    /**
    ...
    AbstractRemoteFormService.prototype.saving = function (_) {
        return exports.whenSaving(this, this.getRequest());
    };
    /***
...
exports.whenResumed = function (cf) {
    return [
        new form_1.SaveCase(form_2.Save, cf),
    ];
};
/**
 * whenSaving
...
exports.whenSaving = function (cf, r) {
    return [
        ...
        new form_1.AbortCase(form_2.Abort, cf),
