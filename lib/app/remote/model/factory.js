...
class RemoteModelFactory {
    ...
    static getInstance(spawn, remote) {
        return new RemoteModelFactory(remote, (0, type_1.isObject)(spawn) ?
            spawn.spawn.bind(spawn) : spawn);
    }
    /**
     ...
     *                 templates.
     */
    create(paths, handlers = [], context = {}) {
        return new _1.RemoteModel(this.remote, normalize(paths), this.spawn, context, Array.isArray(handlers) ?
