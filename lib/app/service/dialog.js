...
exports.DialogService = exports.DOMDialogManager = exports.DialogClosed = exports.ViewContentDestroyed = exports.ViewContentCreated = exports.DialogViewStackEmpty = exports.DialogShown = exports.CloseDialog = exports.PopDialogView = exports.PushDialogView = exports.ShowDialogView = void 0;
 ...
 * DOM node.
 */
var DOMDialogManager = /** @class */ (function () {
    function DOMDialogManager(node) {
        this.node = node;
    }
    DOMDialogManager.prototype.openDialog = function (view) {
        setView(this.node, view);
    };
    DOMDialogManager.prototype.setDialogView = function (view) {
        setView(this.node, view);
    };
    DOMDialogManager.prototype.closeDialog = function () {
        unsetView(this.node);
    };
    return DOMDialogManager;
}());
exports.DOMDialogManager = DOMDialogManager;
